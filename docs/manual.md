...
選手は主催者側の不具合 (ベンチマーカーや参考実装、ポータル等) が疑われる状況や、その他 **疑問点について、速やかに質問を送信することが推奨されます。**

主催者は、主催者側の責によって特定のチームの競技進行に不利益が認められる時、そのチームに対して競技時間の補填を行うことがあります。この際、補填時間の算出は不具合等を主催者が認識してからそれが解決されるまでにかかった時間までを基準とします。つまり、選手は疑問点や不具合の報告を速やかに質問にて行うことで、競技進行に支障があった時間を客観的に明らかにすることができるため、主催者はこれを推奨します。
